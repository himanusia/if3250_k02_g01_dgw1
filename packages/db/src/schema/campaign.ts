...
export const campaign = pgTable("campaign", {
  ...
  budgetIdr: integer("budget_idr").default(0).notNull(),
  periodStart: timestamp("period_start").notNull(),
  periodEnd: timestamp("period_end").notNull(),
  keywords: text("keywords").default("").notNull(),
  targetContentCount: integer("target_content_count").default(0).notNull(),
  targetPostCount: integer("target_post_count").default(0).notNull(),
  targetReelCount: integer("target_reel_count").default(0).notNull(),
  targetStoryCount: integer("target_story_count").default(0).notNull(),
